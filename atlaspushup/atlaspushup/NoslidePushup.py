...
class Trajectory():
    ...
    def __init__(self, node):
        ...
        legWidth = 1
        self.rFootx = pxyz(0.1,-0.1*legWidth,self.footLength)
        self.lFootx = pxyz(0.1,0.1*legWidth,self.footLength)
    ...
    def evaluateJoints(self, t, dt):
        ...
        if (t > 1 and round(t,2) % self.pushupDuration == 0):
            print(self.q, "\n\n\n")
